...
public class GameTreeTest
{
	...
	public static void setUp() throws FileNotFoundException {
		 ...
		 * rattlesnake
		 */
		aGame = new GameTree(PATH + "animals.txt", true);
	...
	// 	GameTree aGame = new GameTree(PATH + "animals.txt", true);
	// 	aGame.playerSelected(Choice.Yes);
	// 	aGame.playerSelected(Choice.Yes);
	...
	// 	aGame.saveGame();
	// 	GameTree anotherGame = new GameTree(PATH + "animals.txt", true);

	// 	anotherGame.playerSelected(Choice.Yes);
	// 	anotherGame.playerSelected(Choice.Yes);
	// 	System.out.println("cur " + aGame.getCurrent());
	// 	aGame.add("Can it swim?", "goose");
	// 	assertEquals("Can it swim?", aGame.getCurrent());
	// 	anotherGame.playerSelected(Choice.Yes);
